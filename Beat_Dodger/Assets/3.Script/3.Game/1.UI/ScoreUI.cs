...
{
    /// <summary>
    /// Professional Score UI with smooth counting and punchy feedback.
    /// Follows premium design principles with subtle animations.
    /// </summary>
    public class ScoreUI : MonoBehaviour
    {
        ...
        private IEnumerator CountToScore()
        {
            ...
            while (elapsed < countDuration)
            {
                ...
                // Use smooth step for more premium feel
                t = t * t * (3f - 2f * t);
        ...
        private void UpdateText()
        {
            if (scoreText != null)
            {
                // Format with commas for readability (premium feel)
