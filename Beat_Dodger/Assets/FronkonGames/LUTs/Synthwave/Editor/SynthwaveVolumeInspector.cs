...
{
  [CustomEditor(typeof(SynthwaveVolume))]
  public class SynthwaveVolumeInspector : Inspector
  {
    protected override void InspectorGUI()
    {
      ...
      // Synthwave.
      /////////////////////////////////////////////////
      DrawEnumDropdownWithReset("mode", "Mode", Synthwave.Modes.Quality);
      DrawProfileWithReset("profile", "LUT Profile");
      DrawEnumDropdownWithReset("tonemap", "Tonemap", Synthwave.Tonemappers.None);
    ...
    protected override void ResetValues() => ((SynthwaveVolume)target).Reset();

    protected override void CheckForErrors()
    {
      if (Synthwave.IsInAnyRenderFeatures() == false)
      {
        Separator();
      ...
      {
        Synthwave[] effects = Synthwave.Instances;
