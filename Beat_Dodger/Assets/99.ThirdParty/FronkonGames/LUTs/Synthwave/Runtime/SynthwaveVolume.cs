...
{
  /// <summary> Synthwave Volume. </summary>
  [Serializable, VolumeComponentMenu("Fronkon Games/LUTs/Synthwave"), HelpURL(Constants.Support.Documentation)]
  public sealed class SynthwaveVolume : VolumeComponent, IPostProcessComponent
  {
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    #region Synthwave settings.

    /// <summary> Quality or performance mode. </summary>
    public EnumParameterNoInterpolation<Synthwave.Modes> mode = new(Synthwave.Modes.Quality);
    ...
    public EnumParameterNoInterpolation<Synthwave.Tonemappers> tonemap = new(Synthwave.Tonemappers.None);
    ...
    public void Reset()
    {
      ...
      mode.value = Synthwave.Modes.Quality;

      tonemap.value = Synthwave.Tonemappers.None;
      exposure.value = 0.0f;
      contrast.value = 0.0f;
    ...
    public bool IsActive()
    {
      ...
      Texture3D texture3D = mode.value == Synthwave.Modes.Quality ? profile.value.quality : profile.value.performance;
