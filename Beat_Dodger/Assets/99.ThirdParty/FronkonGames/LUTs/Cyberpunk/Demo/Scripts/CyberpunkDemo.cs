...
{
  /// <summary> LUTs: Cyberpunk demo. </summary>
  /// <remarks>
  /// This code is designed for a simple demo, not for production environments.
  /// </remarks>
  public class CyberpunkDemo : MonoBehaviour
  {
    ...
    private void Awake()
    {
      ...
      volume = volumeProfile != null && volumeProfile.TryGet(out CyberpunkVolume vol) ? vol : null;
      this.enabled = Cyberpunk.IsInRenderFeatures() && volume != null;
    }
    ...
    private void OnGUI()
    {
      ...
      GUILayout.BeginHorizontal();
      {
        ...
        GUILayout.BeginVertical("box", GUILayout.Width(width), GUILayout.Height(Screen.height));
        {
          ...
          GUILayout.Label("CYBERPUNK DEMO", styleTitle);
